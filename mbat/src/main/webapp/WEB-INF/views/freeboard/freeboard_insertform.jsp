    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">SY Page</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">이곳은 자유 게시판 입니다. 
                    <a target="_blank" href="https://www.google.com">구글 메인으로</a></p>
                            ...
                            <div class="table-responsive">
                                <form name="form" id="form" role="form" method="post" action="/freeboard/insert">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="pass" id="pass" placeholder="비밀번호를 입력해 주세요">
                                    </div>
                                    <div class="mb-3">
